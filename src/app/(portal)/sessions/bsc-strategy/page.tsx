...
export const metadata = {
  title: 'BSC Strategy Masterclass | Altus Collective',
      ...
      <footer className="bg-gray-900 text-white py-12 mt-12">
        <div className="container max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <h4 className="font-bold mb-3">About Altus</h4>
              <p className="text-gray-400 text-sm">
                Connecting industry leaders through expert-led masterclasses and strategic peer collaboration
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="space-y-1 text-sm text-gray-400">
                <p>Email: sessions@altuscollective.us</p>
