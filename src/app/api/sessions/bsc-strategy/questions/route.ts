/**
 * API Route: GET/POST Questions for BSC Strategy Session
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('GET /api/sessions/bsc-strategy/questions:', error);
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('POST /api/sessions/bsc-strategy/questions:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
